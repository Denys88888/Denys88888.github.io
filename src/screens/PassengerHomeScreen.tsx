  ...
  return (
    <div className="flex h-full flex-col">
      <div className="relative h-[52%]">
        ...
        />
        <div className="pointer-events-none absolute inset-x-0 top-2 z-map flex justify-center">
        ...
        <button
          ...
          className="absolute bottom-20 right-4 z-map flex h-12 w-12 items-center justify-center rounded-full bg-primary text-white shadow-fab active:scale-95"
