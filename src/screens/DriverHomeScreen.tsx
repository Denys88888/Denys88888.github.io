    ...
    <div className="flex h-full flex-col">
      <div className="relative h-[40%]">
        ...
        <button
          ...
          className={cn(
            'absolute left-4 top-4 z-map inline-flex items-center gap-1.5 rounded-full px-5 py-2.5 text-sm font-semibold text-white shadow-fab',
        ...
        <button
          ...
          className="absolute bottom-20 right-4 z-map flex h-11 w-11 items-center justify-center rounded-full bg-primary text-white shadow-fab active:scale-95"
