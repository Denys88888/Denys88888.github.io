...
export function BottomNav() {
  ...
  return (
    <nav className="surface z-40 flex shrink-0 items-stretch justify-around border-t border-black/5 dark:border-white/10" style={{ paddingBottom: 'max(var(--safe-bottom), 12px)' }}>
      {tabs.map((tab) => {
